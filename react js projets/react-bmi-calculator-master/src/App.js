...
class App extends Component {
  ...
  constructor(props) {
     super(props);
     this.state = { name: '', weight: 90, height: 180, bmi: 27, message: '', optimalweight: '',  };
      ...
      <div className="App">
        <div className="App-header">
          ...
          <form onSubmist={this.submitMe}>
            ...
            <label>{this.state.checked} Hello {this.state.name}, How are you my friend ? Your BMI is {this.state.bmi} </label>
